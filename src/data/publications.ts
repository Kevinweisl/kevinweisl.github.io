...
export const publicationsData: Publication[] = [
  {
    ...
    doiLink: "https://doi.org/10.18653/v1/2026.findings-acl.1864",
    bibtex: `@inproceedings{wu-etal-2026-one,
    title = "No One Fits All: From Fixed Prompting to Learned Routing in Multilingual {LLM}s",
    author = "Wu, Wei-Chi and Wei, Sheng-Lun and Huang, Hen-Hsen and Chen, Hsin-Hsi",
  ...
  },
  {
    ...
    pdfLink: "https://lrec.elra.info/lrec2026-main-716",
    doiLink: "https://doi.org/10.63317/4jtpgzks8pbr",
    bibtex: `@inproceedings{wei-etal-2026-do,
    title = {Do Multimodal LLMs Understand Order? Measuring the Fragility of Multimodal Reasoning under Input Order Perturbations},
    author = {Wei, Sheng-Lun and Liao, Yu-Ling and Huang, Hen-Hsen and Chen, Hsin-Hsi},
  ...
  },
  {
    ...
    doiLink: "https://doi.org/10.18653/v1/2026.findings-eacl.80",
